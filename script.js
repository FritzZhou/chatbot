...
5.) Expand our educational thrust for the poor.`
        ...
        function getBotResponse(userText) {
            ...
            return 'I\'m not sure I understood that question. I can help you with information about enrollment, admission, tuition, class schedules, the registrar\'s office, scholarships, requirements, and contact details. What would you like to know?';
        }
        ...
        window.addEventListener('load', () => {
            const welcomeText = 'Hi Groupmates, inamo dirk lloyd pelare';
